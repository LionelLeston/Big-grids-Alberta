...
# --------------------------------------------------------------------
y.data<-read.csv("recast.CAWA.csv", header=T)
head(y.data)
...
write.csv(site_year_weights_600, "CAWA_weights_600.csv")

CAWA_weights_600<-read.csv("CAWA_weights_600.csv", header=T)
str(CAWA_weights_600)
#need to change to matrix, transpose matrix, then stack the transposed columns?
CAWA_weights_600.m<-as.matrix(CAWA_weights_600[,2:20])
CAWA_weights_600.t<-t(CAWA_weights_600.m)
CAWA_weights_600.tdf<-as.data.frame(CAWA_weights_600.t)
CAWA_weights_600.stacked<-stack(CAWA_weights_600.tdf)
str(CAWA_weights_600.stacked)
CAWA_weights_600.stacked<-CAWA_weights_600.stacked 
write.csv(CAWA_weights_600.stacked, "CAWA_weights_600.stacked.csv")
...
write.csv(site_year_weights_400, "CAWA_weights_400.csv")

CAWA_weights_400<-read.csv("CAWA_weights_400.csv", header=T)
str(CAWA_weights_400)
#need to change to matrix, transpose matrix, then stack the transposed columns?
CAWA_weights_400.m<-as.matrix(CAWA_weights_400[,2:20])
CAWA_weights_400.t<-t(CAWA_weights_400.m)
CAWA_weights_400.tdf<-as.data.frame(CAWA_weights_400.t)
CAWA_weights_400.stacked<-stack(CAWA_weights_400.tdf)
str(CAWA_weights_400.stacked)
CAWA_weights_400.stacked<-CAWA_weights_400.stacked 
write.csv(CAWA_weights_400.stacked, "CAWA_weights_400.stacked.csv")
...
write.csv(site_year_weights_200, "CAWA_weights_200.csv")

CAWA_weights_200<-read.csv("CAWA_weights_200.csv", header=T)
str(CAWA_weights_200)
#need to change to matrix, transpose matrix, then stack the transposed columns?
CAWA_weights_200.m<-as.matrix(CAWA_weights_200[,2:20])
CAWA_weights_200.t<-t(CAWA_weights_200.m)
CAWA_weights_200.tdf<-as.data.frame(CAWA_weights_200.t)
CAWA_weights_200.stacked<-stack(CAWA_weights_200.tdf)
str(CAWA_weights_200.stacked)
CAWA_weights_200.stacked<-CAWA_weights_200.stacked 
write.csv(CAWA_weights_200.stacked, "CAWA_weights_200.stacked.csv")
