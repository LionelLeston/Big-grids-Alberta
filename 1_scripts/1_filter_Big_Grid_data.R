...
bg.all<-read.csv("0_data/processed/1_Big_Grids_AllAsOfNov5_2020.csv", header=TRUE)
...
#There are date, time, weather, observer,
...
write.csv(bg.3min, file="0_data/processed/2_Big_Grids_3min_AsOfNov5_2020.csv")
...
bg.3min<-read.csv("0_data/processed/2_Big_Grids_3min_AsOfNov5_2020.csv", header=TRUE)
...
#as of November 5, 2020 there are 40 individual birds that were heard first after 3 minutes
...
nrow(bg.3min.extrabirds.rem)#79207...forty less birds
write.csv(bg.3min.extrabirds.rem, file="0_data/processed/3_Big_Grids_ExtrasRemoved_3min_AsOfNov5_2020.csv")
...
bg.3min.song<-read.csv("0_data/processed/3_Big_Grids_ExtrasRemoved_3min_AsOfNov5_2020.csv", header=TRUE)
...
nrow(bg.3min.birdsonly)#78860

#At least we've removed amphibian observations where abundance = CI 1, CI 2, or CI 3
write.csv(bg.3min.birdsonly, file="0_data/processed/4_Big_Grids_BirdsOnly_3min_AsOfNov5_2020.csv")
